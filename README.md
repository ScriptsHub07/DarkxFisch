...
W:AddLabel("[+] Lures Script o melhor de todos")
W:AddLabel("[+] Melhor Auto Farm")
W:AddLabel("[+] Upe Rapido")
...
M:AddToggle({
    Name = "Kaitun[Não derrota players]",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Lures Script(Noitification)",
